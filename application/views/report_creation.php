	...
	<?php } ?> 
		...
		<div class="d-flex justify-content-end flex-wrap m-3">
			<div class="custom-control custom-checkbox">
				...
				<input type="checkbox" class="custom-control-input" id="1111" name="is_app">
...
<script type="text/javascript">
	...
	<?php if(isset($_GET['id'])){?> 
		$(document).ready(function($) {
			...
			localStorage.setItem('type','<?= $data_list[0]->type?>');
		}); 
...
<?php  }else { ?>
	...
	localStorage.setItem('company_name','<?= (isset($company_name))? $company_name : 0?>');
	<?php
